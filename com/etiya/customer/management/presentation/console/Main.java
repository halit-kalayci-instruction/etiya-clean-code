...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        ICustomerCheckService customerCheckService = new CustomerCheckService();

        OrderBusinessRules orderBusinessRules = OrderBusinessRules.getInstance(orderRepository);
        CustomerBusinessRules customerBusinessRules = CustomerBusinessRules.getInstance(customerRepository,customerCheckService);

        // IoC Yönetimi
        ICustomerService customerService = new CustomerService(
                customerRepository,
                consoleLogger,
                customerCheckService);
        ...
        IOrderService orderService = new OrderService(orderServiceFacade);
